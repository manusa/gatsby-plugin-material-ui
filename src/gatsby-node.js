...
exports.pluginOptionsSchema = ({Joi}) => Joi.object({
  pathToEmotionCacheProps: Joi.string()
    .default('')
    .description('The path to the emotion cache props (See https://emotion.sh/docs/@emotion/cache#createcache).')
});
...
// Copy and paste from https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-plugin-typography
